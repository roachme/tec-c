...
[conv](https://github.com/roachme/tec-conv.git) - Workflow engine \
[find](https://github.com/roachme/tec-find.git) - Find stuff in tasks \
[fsck](https://github.com/roachme/tec-fsck.git) - Check and repair filesystem \
[gmux](https://github.com/roachme/tec-gmux.git) - Manage a bunch of git repos \
[link](https://github.com/roachme/tec-link.git) - Link tasks \
[nine](https://github.com/roachme/tec-nine.git) - Tec plugin manager \
[note](https://github.com/roachme/tec-note.git) - Note taking plugin \
[tar](https://github.com/roachme/tec-tar.git) - Tec archiver
